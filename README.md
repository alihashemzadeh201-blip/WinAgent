...
می‌توانید به ایجنت **مهارت‌های خاص** بیاموزید: هر مهارت یک فایل متنی (`.md` / `.txt`) است که یک رویهٔ مرحله‌به‌مرحله را شرح می‌دهد. فایل را در یکی از این دو پوشه بگذارید تا **خودکار** بارگذاری و به system prompt افزوده شود (بدون تغییر کد و بدون ری‌استارت دستی):
